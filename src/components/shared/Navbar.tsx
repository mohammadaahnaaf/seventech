...
export const Navbar = (props: Props) => {
  ...
  return view ? (
      <div className='flex justify-between py-2 items-center gap-4 px-4 lg:px-0 max-w-7xl mx-auto w-full'>
        {/* Mobile Menu  */}
        ...
        <div className="hidden md:block">
          <div className="flex items-center">
            ...
            <Menu as="div" className="ml-3 relative">
              <div>
                <Menu.Button className="text-black bg-black bg-opacity-10 flex p-[8px] rounded-full relative hover:text-sky-600 focus:ring-0">
