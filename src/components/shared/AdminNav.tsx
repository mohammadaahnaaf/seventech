            ...
            <Disclosure as="nav" className="bg-white">
                {({ open }) => (
                    <>
                        <div className="max-w-7xl mx-auto px-4 lg:px-0">
                            <div className="flex items-center justify-between h-16">
                                    ...
                                    <div className="ml-4 flex items-center md:ml-6">
                                        ...
                                        {!useri && (
                                            <div className='flex justify-between gap-2 ml-3'>
                                                <Link href='/signin' className='bg-sky-600 hover:bg-white text-white ring-0 focus:ring-1 ring-white hover:ring-sky-600 hover:text-black py-1 px-3 rounded-sm'>
                                                    Signup
                                                </Link>
                                                <Link href='/login' className='bg-white hover:bg-sky-600 ring-0 focus:ring-1 ring-sky-600 hover:ring-white hover:text-white py-1 px-3 rounded-sm'>
                                                    Login
                                                </Link>
                                            </div>
                                        )}
                                        ...
                                        <Menu as="div" className="ml-3 relative">
                                            <div>
                                                {useri && (
                                                    <Menu.Button className="text-sky-600 hover:bg-gray-600 hover:bg-opacity-25 bg-sky-600 focus:bg-opacity-25 bg-opacity-30 flex p-[8px] rounded-full relative hover:text-red-600">
                                ...
                                <div className="-mr-2 flex md:hidden">
                                    ...
                                    {/* Mobile menu button */}
                                    <Disclosure.Button className="focus:bg-opacity-20 bg-opacity-5 bg-black inline-flex items-center justify-center p-2 rounded-md text-black">
                        ...
                        >
                            <Disclosure.Panel className="md:hidden bg-gray-500">
                                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                                    {navigation.map((item) => (
                                        <Disclosure.Button
                                            key={item.name}
                                            onClick={() => router.push(`/${item.href}`)} className={classNames(
                                                pathname === item.href ? 'bg-black bg-opacity-10 text-white' : '',
