...
export function Terms() {
  ...
  async function handleDelete(id: any) {
    try {
      await axiosAPI.delete(`/content/terms/${id}`);
                ...
                <div className='grid gap-2 px-3 w-full'>
                  <div className='w-full'>
                    ...
                    <div className='w-full'>
                      ...
                      <textarea rows={3} name='newdescription' value={newdescription || ''} onChange={(e) => setNewdescription(e.target.value)} id="newdescription" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-600 focus:border-red-600 block w-full px-2.5" placeholder="Desciption" required />
                    </div>
                  </div>
                </div>
